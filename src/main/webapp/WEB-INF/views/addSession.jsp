		...
		<form:form  modelAttribute="newMember" class="form-horizontal"  >
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="date" path="date" type="text" class="form:input-large"/>
						<form:errors path="date" cssClass="text-danger"/>
					</div>
				</div>

				<div class="form-group">
					<label class="control-label col-lg-2" for="startTime">First Name</label>
					<div class="col-lg-10">
						<form:input id="startTime" path="startTime" type="text" class="form:input-large"/>
						<form:errors path="startTime" cssClass="text-danger"/>
					</div>
				</div>

				<div class="form-group">
					<label class="control-label col-lg-2" for="duration">Last Name</label>
					<div class="col-lg-10">
						<form:input id="duration" path="duration" type="text" class="form:input-large"/>
						<form:errors path="duration" cssClass="text-danger"/>
					</div>
				</div>

				<div class="form-group">
					<label class="control-label col-lg-2" for="numberofsits">Age</label>
					<div class="col-lg-10">
						<form:input id="numberofsits" path="numberofsits" type="text" class="form:input-large"/>
