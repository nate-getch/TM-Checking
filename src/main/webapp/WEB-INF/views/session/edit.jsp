			...
			<form:form modelAttribute="session" action="add"
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<form:input id="sessionDate" path="date" cssClass="form-control"
					...
					<div class="form-group">
						...
						<form:input id="duration" path="duration" cssClass="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="4"/>
					...
					<div class="form-group">
						...
						<form:input id="building" path="location.building"
							cssClass="form-control" maxlength="25" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
